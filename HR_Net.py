...
#from ~ensorflow_core.python.keras.layers.pooling import MaxPooling1D
...
def fuse_layer3(x):
    x0_0 = x[0]
    x0_0 = Conv2D(32, 1, use_bias=False, kernel_initializer='he_normal')(x0_0)
    x0_0 = MaxPooling2D(pool_size=(1, 16),  padding="valid")(x0_0)
    
    x0_1 = Conv2D(32, 1, use_bias=False, kernel_initializer='he_normal')(x[1])
    x0_1 = BatchNormalization(axis=3)(x0_1)
    x0_1 = UpSampling2D(size=(2, 1))(x0_1)
    x0_1 = Conv2D(32, 1, use_bias=False, kernel_initializer='he_normal')(x0_1)
    x0_1 = MaxPooling2D(pool_size=(1, 8),  padding="valid")(x0_1)
    
    
    x0_2 = Conv2D(32, 1, use_bias=False, kernel_initializer='he_normal')(x[2])
    x0_2 = BatchNormalization(axis=3)(x0_2)
    x0_2 = UpSampling2D(size=(4, 1))(x0_2)
    x0_2 = Conv2D(32, 1, use_bias=False, kernel_initializer='he_normal')(x0_2)
    x0_2 = MaxPooling2D(pool_size=(1, 4),  padding="valid")(x0_2)
    
    x0_3 = Conv2D(32, 1, use_bias=False, kernel_initializer='he_normal')(x[3])
    x0_3 = BatchNormalization(axis=3)(x0_3)
    x0_3 = UpSampling2D(size=(8, 1))(x0_3)
    x0_3 = Conv2D(32, 1, use_bias=False, kernel_initializer='he_normal')(x0_3)
    x0_3 = MaxPooling2D(pool_size=(1, 2),  padding="valid")(x0_3)
...
def final_layer(x, classes=1):
    ...
    # sequeeze the height into 1 by maxpooling/averagepooling pooling
    #x = MaxPooling2D(pool_size=(1, 16),  padding="valid")(x)
